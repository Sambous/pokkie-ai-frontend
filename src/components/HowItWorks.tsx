...
export function HowItWorks() {
  return (
    <section id="how" className="scroll-mt-20 border-t border-white/5 py-24 sm:py-28">
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        ...
        <p className="mt-3 max-w-lg text-blush-deep/85">
        ...
        <ol className="mt-14 grid gap-6 md:grid-cols-3">
          {steps.map((step, i) => (
            <motion.li
              ...
              className="relative"
            >
              <span className="font-display text-6xl font-extrabold text-white/[0.06]">
                {i + 1}
              </span>
